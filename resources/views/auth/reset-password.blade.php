...
@section('title', 'Reset Password - Sasak Sade')
                ...
                <div class="row g-0">
                    <div class="col-lg-5">
                        <div class="password-panel">
                            ...
                            <h2 class="fw-bold mb-3">Buat Password Baru</h2>
                            <p class="text-white-50 mb-0">
                                Masukkan password baru agar akun Anda bisa digunakan kembali.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="password-form">
                            ...
                            <p class="text-muted mb-4">Pastikan password baru mudah diingat dan minimal 8 karakter.</p>
